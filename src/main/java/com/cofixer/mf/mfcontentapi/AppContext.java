...
public class AppContext {
    ...
    //토근 만료 시간
    public static final long ACCESS_TOKEN_EXPIRE_SECOND = TemporalUtil.HOUR_IN_SECONDS;
    public static final long REFRESH_TOKEN_EXPIRE_SECOND = TemporalUtil.WEEK_IN_SECONDS;
}
